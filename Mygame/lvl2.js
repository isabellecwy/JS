...
class lvl2 extends Phaser.Scene {
    ...
    this.anims.create({
     ...
     this.physics.add.overlap(this.player, this.key2, this.hitKey2, null, this);
     this.physics.add.overlap(this.player, this.key3, this.hitKey3, null, this);
     this.physics.add.overlap(this.player, this.key4, this.hitKey4, null, this);
